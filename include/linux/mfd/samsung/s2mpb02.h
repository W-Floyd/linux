...
#ifndef __LINUX_MFD_S2MPB02_H
#define __LINUX_MFD_S2MPB02_H
...
/*
 * Each LDO holds its enable bit (7) and voltage selector (6:0) in a single
 * LnCTRL register. The bucks split these: BxCTRL1 enables via a two-bit
 * field (7:6), BxCTRL2 holds the selector.
 */
